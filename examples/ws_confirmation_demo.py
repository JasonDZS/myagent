...
async def main():
    ...
    server = AgentWebSocketServer(
        agent_factory_func=create_confirmation_agent, host="localhost", port=8890
    )

    logger.info(
        "Starting WebSocket server with user confirmation demo on ws://localhost:8890"
    )
