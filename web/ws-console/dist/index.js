...
var MyAgentCtx = (0, import_react.createContext)(null);
...
function useMyAgent() {
  const ctx = (0, import_react.useContext)(MyAgentCtx);
...
function MessageItem({ m, onConfirm, onDecline }) {
  ...
  const [collapsed, setCollapsed] = (0, import_react2.useState)(() => !isConfirm);
  ...
  const [json, setJson] = (0, import_react2.useState)("");
  ...
  const [editMode, setEditMode] = (0, import_react2.useState)("form");
  const [formTasks, setFormTasks] = (0, import_react2.useState)([]);
...
function MyAgentConsole({ className }) {
  ...
  const onMountCreate = import_react5.default.useRef(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: `ma-console ${className ?? ""}`.trim(), children: [
